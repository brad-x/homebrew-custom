class Virglrenderer < Formula
  ...
  depends_on "akiautiste/qemu-virgl/libangle"
  depends_on "akiautiste/qemu-virgl/libepoxy-angle"

  # waiting for upstreaming of https://github.com/akihikodaki/virglrenderer/tree/macos
  patch :p1 do
    url "https://github.com/brad-x/homebrew-custom/raw/main/patches/virglrenderer/virglrenderer-v04.diff"
